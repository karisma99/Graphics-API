...
private:
	...
	void privLoadDataFromFile(const char * const _modelName, StandardVertex*& pVerts, int& nverts, TriangleByIndex*& ptlist, int& ntri, Vect scale);
...
public:
	...
	Model(ID3D11Device* dev, const char * const _modelName, Vect scale = Vect(1, 1, 1));
